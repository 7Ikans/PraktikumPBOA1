public class MManusia {
    public static void main(String[] args) {
        ...
        System.out.println("Pajak PNS p1       = Rp " + (long)p1.hitungPajak());
        System.out.println("Pajak Pengusaha pe1= Rp " + (long)pe1.hitungPajak());
        System.out.println("Pajak Petani pt1   = Rp " + (long)pt1.hitungPajak());
        System.out.println("------------------------------------------");
